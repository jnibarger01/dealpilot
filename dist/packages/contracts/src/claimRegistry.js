export const CLAIM_DEFINITIONS = [
    {
        ...
        unblockText: "Asking price is the seller's term; cross-check listing feeds for consistency.",
        unit: "USD",
    ...
    },
    {
        ...
        unblockText: "Upload trailing-12 financials and leases so income can be checked against deposits.",
        unit: "USD",
    ...
    },
    {
        ...
        materiality: "blocking",
        unblockText: "Upload the latest county tax bill or retry the assessor adapter.",
        unit: "USD",
    ...
    },
    {
        ...
        materiality: "contextual",
        unblockText: "Upload any document showing construction year, such as an appraisal or permit.",
        unit: "YEAR",
...
export function getClaimDefinition(type) {
    const found = CLAIM_DEFINITIONS.find((definition) => definition.type === type);
    if (!found) {

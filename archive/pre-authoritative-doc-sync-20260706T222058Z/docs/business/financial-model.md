...
## 12. Reconciliation to Repo Canon (cross-check table)

| Number | Value here | Also appears in |
|---|---|---|
| ARR Y1–Y5 | 0.6 / 2.8 / 9.0 / 22 / 46 ($M) | README, `executive-summary.md`, `../investor/pitch-deck.md` S13 |
| Seed / A / B | $4M @ $16M post / $15M mo 22–26 / $35M mo 44–50 | `fundraising.md`, `../investor/cap-table.md` |
| GM 66%→80%; memo COGS $11→$4; marginal credit COGS $0.90→$0.45 | §1.3, §3, §10 | `pricing.md`, `business-plan.md`, `../architecture/ai-architecture.md` §7 |
| Headcount 11/23/48/88/148 | §6 | `../operations/hiring.md` |
| Downshift: mo-18 ARR < $1.0M → freeze at 14 | §4.3 | `fundraising.md`, `../roadmap/v1.md` §6 |
| A-gates (ARR $1.8M, NRR 105%, 6 logos/1.5K seats, GM 72%) | §7 | `../roadmap/enterprise.md` §7, `../investor/*` |

Any doc that disagrees with this table is wrong and gets fixed toward it.

...
| 101 | **Cross-doc doctrine drift**: product/legal/marketing/API docs diverge on regulated meaning (the operational cause of perimeter fragility) | LEG | 4 | 3 | 12 | L | H | Canonical registries (numbers `financial-model.md` §12, risk IDs = this file, decision-memo definition `../product/prd.md`), banned-phrase lint (`/tools/lint-docs.sh`), review-disposition process (`review-response.md`) — new entrant 2026-07, pending quarterly re-rank |
